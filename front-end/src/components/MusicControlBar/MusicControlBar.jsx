...
import { PremiumRequired, PremiumTooltip } from '..'
    ...
    <div className={styles.musicControlBar}>
      ...
      <div className={styles.playerControls}>
        <div className={styles.controlButtons}>
          <PremiumTooltip 
            show={!isPremium} 
            message="Pular faixas é exclusivo para usuários Premium"
          >
            <button 
              className={`${styles.controlButton} ${!isPremium ? styles.disabled : ''}`}
      ...
      <div className={styles.volumeControls}>
        <PremiumTooltip 
          show={!isPremium} 
          message="Controle de volume é exclusivo para usuários Premium"
        >
          <button 
            className={`${styles.volumeButton} ${!isPremium ? styles.disabled : ''}`}
            onClick={() => isPremium && setShowVolumeSlider(!showVolumeSlider)}
