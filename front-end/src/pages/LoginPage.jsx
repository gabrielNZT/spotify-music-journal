...
function LoginPage() {
  ...
  const handleSpotifyLogin = async () => {
    ...
    try {
      ...
      setError('Erro ao conectar com o Spotify. Tente novamente.')
      setIsLoading(false)
    }
  }
      ...
      <div className={styles.loginBox}>
        ...
        <div className={styles.appInfo}>
          ...
          <p className={styles.appDescription}>
            Crie anotações pessoais e organize suas músicas favoritas em categorias personalizadas. 
            Seu diário musical integrado ao Spotify.
          </p>
        </div>
      </div>
    </div>
